  ...
  return (
    <div style={{width:180,height:120,display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column'}}>
      ...
      <svg viewBox="0 0 100 60" width={180} height={120}>
        ...
        <text x="50" y="36" textAnchor="middle" fill="var(--fg)" fontSize="14" fontWeight={700}>{value}%</text>
        <text x="50" y="62" textAnchor="middle" fill="var(--muted)" fontSize={12}>Soil Moisture</text>
      </svg>
    </div>
  )
}
